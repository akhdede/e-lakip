...
class M_print extends CI_Model
{
	...
	{
		$this->db->select('menu.id, menu.nama, isi_menu.konten, isi_menu.selesai');
		$this->db->from('menu');
	...
	{
		$this->db->select('submenu.id, submenu.nama, submenu.id_menu, isi_submenu.konten, isi_submenu.selesai');
